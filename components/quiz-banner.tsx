        ...
        <div className="max-w-7xl mx-auto relative rounded-[3rem] overflow-hidden bg-zinc-900 group">
          ...
          <div className="relative z-10 p-8 md:p-20 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-[#B59461]/20 border border-[#B59461]/30 px-4 py-1.5 rounded-full">
                <Sparkles className="h-3.5 w-3.5 text-[#B59461]" />
                <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#B59461]">AI Skin Analysis</span>
              </div>
              
              <h2 className="text-4xl md:text-6xl font-serif text-white leading-[1.1]">
                Find Your <br />
                <span className="italic text-[#B59461]">Perfect Ritual</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
                <Button 
                  ...
                  size="lg" 
                  className="bg-[#B59461] hover:bg-[#967a4f] text-white rounded-full px-10 h-14 text-md font-bold group/btn shadow-xl shadow-[#B59461]/20"
                >
                  Start Skin Quiz 
                  <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover/btn:translate-x-1" />
                </Button>
                <p className="text-zinc-500 text-sm font-medium flex items-center gap-2">
                  <Zap className="h-4 w-4 text-[#B59461]" /> Powered by JMC Pro
                </p>
              </div>
            </div>
            ...
            <div className="flex-1 w-full max-w-md hidden md:block">
              <div className="relative">
                <div className="absolute inset-0 bg-[#B59461] blur-[100px] opacity-20"></div>
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] space-y-8 shadow-2xl">
                  <div className="flex justify-between items-start">
                    <div className="h-14 w-14 rounded-2xl bg-[#B59461] flex items-center justify-center shadow-lg shadow-[#B59461]/40">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between text-xs font-bold uppercase text-zinc-400">
                      ...
                      <span className="text-[#B59461]">JMC 2.5 Flash</span>
                    </div>
                    <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-[#B59461] w-1/3 rounded-full animate-pulse"></div>
                    </div>
                  </div>
