          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 text-center md:text-left">
            <div className="space-y-6 md:col-span-1 flex flex-col items-center md:items-start">
              <Link href="/" className="flex items-center gap-2">
                <Sparkles className="h-6 w-6 text-[#B59461]" />
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><Link href="/shop" className="hover:text-[#B59461] transition-colors">Bestsellers</Link></li>
                <li><Link href="/shop" className="hover:text-[#B59461] transition-colors">New Arrivals</Link></li>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm">
                <li><Link href="#" className="hover:text-[#B59461] transition-colors">Contact Us</Link></li>
                <li><Link href="#" className="hover:text-[#B59461] transition-colors">Shipping & Returns</Link></li>
                <li><Link href="#" className="hover:text-[#B59461] transition-colors">FAQ</Link></li>
