...
export function Newsletter() {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-white">
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 h-96 w-96 bg-[#50540b]/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 h-96 w-96 bg-[#50540b]/5 rounded-full blur-3xl"></div>

      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="bg-[#F9F6F0] rounded-[40px] p-8 md:p-16 border border-[#50540b]/10 text-center space-y-8 shadow-sm">
          ...
          <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full border border-zinc-100 mb-2">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#50540b]">Exclusive Access</span>
          </div>
            ...
            <form action={handleSubmit} className="relative max-w-md mx-auto group">
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <div className="relative w-full group">
                  <Mail className="absolute left-5 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-400 group-focus-within:text-[#50540b] transition-colors" />
                  <input 
                    name="email"
                    type="email" 
                    placeholder="yourname@email.com" 
                    required
                    className="w-full h-14 pl-12 pr-6 rounded-full border-2 border-white focus:border-[#50540b] bg-white shadow-xl shadow-zinc-200/50 outline-none transition-all text-sm font-medium"
                  />
                </div>
                <Button 
                  disabled={loading}
                  className="h-14 w-full sm:w-auto px-10 bg-[#50540b] text-white rounded-full font-bold hover:bg-[#967a4f] transition-all shadow-lg shadow-[#50540b]/30 shrink-0"
                >
